                    ...
                    <form action="{{ route('lokasi.update', $lokasi) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="kecamatan_id" class="form-control" value="{{ old('kecamatan_id', $lokasi->kecamatan_id) }}">
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold">Desa</label>
                                <input type="text" name="desa_id" class="form-control" value="{{ old('desa_id', $lokasi->desa_id) }}">
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 border-top pt-4 mt-4">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary px-4">Perbarui Lokasi</button>
                        </div>
                    </form>
                </div>
            </div>
