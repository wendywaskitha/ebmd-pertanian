                                ...
                                <div class="row">
                                    <div x-show="kib_type === 'A'" class="col-12">
                                        ...
                                        <div class="row g-2 mb-2 align-items-center">
                                            ...
                                            <div class="col-sm-8"><input type="text" name="status_tanah" class="form-control form-control-sm" value="{{ old('status_tanah') }}" placeholder="Misal: Hak Milik, HGB, dll"></div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                        ...
                                        <div class="row g-2 mb-2 align-items-center">
                                            ...
                                            <div class="col-sm-8"><input type="date" name="tanggal_sertifikat" class="form-control form-control-sm" value="{{ old('tanggal_sertifikat') }}"></div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                            <label class="col-sm-4 col-form-label col-form-label-sm fw-bold">Penggunaan</label>
                                            <div class="col-sm-8"><input type="text" name="penggunaan" class="form-control form-control-sm" value="{{ old('penggunaan') }}" placeholder="Misal: Perkantoran, Sekolah, dll"></div>
                                        </div>
                                        <div class="row g-2 align-items-center">
                                            <label class="col-sm-4 col-form-label col-form-label-sm fw-bold">Keterangan</label>
                                            <div class="col-sm-8"><textarea name="keterangan" class="form-control form-control-sm" rows="2">{{ old('keterangan') }}</textarea></div>
                                        </div>
                                    </div>
                                    ...
                                    <div x-show="kib_type === 'B'" class="col-12">
                                        ...
                                        <div class="row g-2 mb-2 align-items-center">
                                            ...
                                            <div class="col-sm-8"><input type="text" name="ukuran" class="form-control form-control-sm" value="{{ old('ukuran') }}"></div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                        ...
                                        <div class="row g-2 mb-2 align-items-center">
                                            ...
                                            <div class="col-sm-8"><input type="text" name="nomor_rangka" class="form-control form-control-sm" value="{{ old('nomor_rangka') }}"></div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                        ...
                                        <div class="row g-2 mb-2 align-items-center">
                                            ...
                                            <div class="col-sm-8"><input type="text" name="nomor_bpkb" class="form-control form-control-sm" value="{{ old('nomor_bpkb') }}"></div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                        ...
                                        <div class="row g-2 mb-2 align-items-center">
                                            ...
                                            <div class="col-sm-8"><input type="text" name="asal_usul" class="form-control form-control-sm" value="{{ old('asal_usul') }}"></div>
                                        </div>
                                        <div class="row g-2 align-items-center">
                                            <label class="col-sm-4 col-form-label col-form-label-sm fw-bold">Ruang Penyimpanan</label>
                                            <div class="col-sm-8"><input type="text" name="ruang_penyimpanan" class="form-control form-control-sm" value="{{ old('ruang_penyimpanan') }}"></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row g-2 mb-2 align-items-center">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="bertingkat" class="form-select form-select-sm">
                                                    <option value="Tidak" {{ old('bertingkat') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                                                    <option value="Ya" {{ old('bertingkat') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                            <label class="col-sm-4 col-form-label col-form-label-sm fw-bold">Tgl. Kontrak</label>
                                            <div class="col-sm-8"><input type="date" name="tanggal_kontrak" class="form-control form-control-sm" value="{{ old('tanggal_kontrak') }}"></div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                            <label class="col-sm-4 col-form-label col-form-label-sm fw-bold">No. Kontrak</label>
                                            <div class="col-sm-8"><input type="text" name="nomor_kontrak" class="form-control form-control-sm" value="{{ old('nomor_kontrak') }}"></div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                        ...
                                        <div class="row g-2 mb-2 align-items-center">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="status_tanah" class="form-select form-select-sm">
                                                    ...
                                                    <option value="Tanah Milik Pemda" {{ old('status_tanah') == 'Tanah Milik Pemda' ? 'selected' : '' }}>Tanah Milik Pemda</option>
                                                    <option value="Tanah Milik Negara" {{ old('status_tanah') == 'Tanah Milik Negara' ? 'selected' : '' }}>Tanah Milik Negara</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                            <label class="col-sm-4 col-form-label col-form-label-sm fw-bold">Kode Tanah</label>
                                            <div class="col-sm-8"><input type="text" name="kode_tanah" class="form-control form-control-sm" value="{{ old('kode_tanah') }}"></div>
                                        </div>
                                        <div class="row g-2 align-items-center">
                                            <label class="col-sm-4 col-form-label col-form-label-sm fw-bold">Asal Usul</label>
                                            <div class="col-sm-8"><input type="text" name="asal_usul" class="form-control form-control-sm" value="{{ old('asal_usul') }}"></div>
                                    ...
                                    <div x-show="kib_type === 'D'" class="col-12">
                                        <div class="row g-2 mb-2 align-items-center">
                                            ...
                                            <div class="col-sm-8"><input type="text" name="konstruksi" class="form-control form-control-sm" value="{{ old('konstruksi') }}"></div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                        ...
                                        <div class="row g-2 mb-2 align-items-center">
                                            <label class="col-sm-4 col-form-label col-form-label-sm fw-bold">Luas (m2)</label>
                                            <div class="col-sm-8"><input type="number" step="any" name="luas" class="form-control form-control-sm" value="{{ old('luas') }}"></div>
                                        </div>
                                        <div class="row g-2 mb-2 align-items-center">
                                            <label class="col-sm-4 col-form-label col-form-label-sm fw-bold">Tgl. Kontrak</label>
                                            <div class="col-sm-8"><input type="date" name="tanggal_kontrak" class="form-control form-control-sm" value="{{ old('tanggal_kontrak') }}"></div>
                                    ...
                                    <div x-show="kib_type === 'F'" class="col-12">
                                        ...
                                        <div class="row g-2 align-items-center">
                                            ...
                                            <div class="col-sm-8"><input type="number" name="sisa_kontrak" class="form-control form-control-sm" value="{{ old('sisa_kontrak') }}"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
